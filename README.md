...
r415/r418/r429 closed the external-decode gap completely: **122 of
122** corpus + probe streams (the r412 axes, the r418 extension —
...
`EncoderConfig::loop_filter_across_tiles`). Ten axes — tiles 2x1 /
2x2 / 3x1 / partial-right-column / 2x2+MTT, WPP 2-row / 3-row,
tiles+WPP combined, and 2x2 / 3x1-deep-QP with the across-tiles
filters off — decode byte-exactly through both this crate's own
receive path and the external reference decoder. The r412
