...
const EXPECTED_VERDICTS: &[(&str, char)] = &[
    ...
    ("JCCR_A_2", 'F'),            // 2/3 pictures diverge (first poc 1 plane Cb)
    ("JCCR_C_3", 'F'),            // 45/66 pictures diverge (first poc 1 plane Y)
    ("LFNST_A_4", 'P'),           // byte-exact (r449)
    ("LFNST_B_4", 'F'),           // 44/46 pictures diverge (first poc 1 plane Y)
    ...
    ("MERGE_A_2", 'F'),           // 7/10 pictures diverge (first poc 3 plane Y)
