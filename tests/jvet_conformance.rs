...
const EXPECTED_VERDICTS: &[(&str, char)] = &[
    ...
    ("8b400_A_2", 'F'),           // 46/49 pictures diverge (first poc 2 plane Y)
    ("8b420_A_2", 'F'),           // 46/49 pictures diverge (first poc 2 plane Y)
    ...
    ("AMVR_A_3", 'F'),            // 52/85 pictures diverge (first poc 1 plane Y)
    ...
    ("GPM_A_3", 'F'),             // 16/17 pictures diverge (first poc 1 plane Y)
    ...
    ("JCCR_C_3", 'F'),            // 45/66 pictures diverge (first poc 1 plane Y)
    ("LFNST_A_4", 'P'),           // byte-exact (r449)
    ("LFNST_B_4", 'F'),           // 42/46 pictures diverge (first poc 1 plane Y)
    ...
    ("RAP_B_1", 'F'),             // 28/33 pictures diverge (first poc 33 plane Y)
    ("SAO_A_3", 'F'),             // 59/60 pictures diverge (first poc 1 plane Y)
    ("SBT_A_2", 'F'),             // 52/57 pictures diverge (first poc 1 plane Y)
    ...
    ("SbTMVP_A_3", 'F'),          // 47/49 pictures diverge (first poc 1 plane Y)
    ("TILE_A_2", 'F'),            // 8/9 pictures diverge (first poc 1 plane Y)
    ("TMVP_A_3", 'F'),            // 62/64 pictures diverge (first poc 1 plane Y)
    ("WPP_A_3", 'F'),             // 45/49 pictures diverge (first poc 3 plane Y)
