...
pub const LAST_SIG_X_PREFIX_SHIFT: &[u8] = &[
    8, 5, 4, 5, 4, 4, 5, 4, 1, 0, 4, 1, 0, 0, 0, 0, 1, 0, 0, 0, 5, 4, 4, 8, 5, 4, 5, 4, 4, 5, 4, 1,
    0, 4, 1, 0, 0, 0, 0, 1, 0, 0, 0, 5, 4, 4, 8, 5, 4, 5, 4, 4, 5, 4, 1, 0, 4, 1, 0, 0, 0, 0, 1, 0,
    0, 0, 5, 4, 4,
];
...
pub const LAST_SIG_Y_PREFIX_INIT: &[u8] = &[
    ...
    4, 6, 14, 5, 12, 14, 7, 13, 5, 13, 21, 14, 20, 12, 34, 11, 4, 18, 5, 5, 20, 13, 13, 19, 21, 6,
    12, 12, 14, 14, 5, 4, 12, 13, 7, 13, 12, 41, 11, 5, 27,
];
pub const LAST_SIG_Y_PREFIX_SHIFT: &[u8] = &[
    8, 5, 8, 5, 5, 4, 5, 5, 4, 0, 5, 4, 1, 0, 0, 1, 4, 0, 0, 0, 6, 5, 5, 8, 5, 8, 5, 5, 4, 5, 5, 4,
    0, 5, 4, 1, 0, 0, 1, 4, 0, 0, 0, 6, 5, 5, 8, 5, 8, 5, 5, 4, 5, 5, 4, 0, 5, 4, 1, 0, 0, 1, 4, 0,
    0, 0, 6, 5, 5,
];
...
pub const SB_CODED_FLAG_SHIFT: &[u8] = &[
    8, 5, 5, 8, 5, 8, 8, 8, 5, 5, 8, 5, 8, 8, 8, 5, 5, 8, 5, 8, 8,
];

/// Table 123 — `sig_coeff_flag` (189 ctxIdx, 63 per initType).
/// r415 — full retranscription: the pre-r415 arrays carried
/// dropped/duplicated entries (init from ctxIdx 86, shiftIdx inside
/// the initType-0 block from ctxIdx 28), which kept this crate's
/// encoder/decoder pair self-consistent but drifted the probability
/// adaptation away from §9.3.2.2/§9.3.4.3.2.2 — the root cause of the
/// r412 sparse-residual external-decoder desync.
pub const SIG_COEFF_FLAG_INIT: &[u8] = &[
    ...
    58, 51, 30, 19, 38, 38, 46, 34, 54, 54, 39, 6, 39, 39, 39, 19, 39, 54, 39, 19, 39, 39, 39, 56,
    39, 39, 39, 17, 34, 35, 21, 41, 59, 60, 38, 35, 45, 53, 54, 44, 39, 39, 39, 34, 38, 62, 39, 26,
    39, 39, 39, 40, 35, 44, 17, 41, 49, 36, 1, 49, 50, 37, 48, 51, 58, 45, 26, 45, 53, 46, 49, 54,
    61, 39, 35, 39, 39, 39, 19, 54, 39, 39, 50, 39, 39, 39, 0, 39, 39, 39, 9, 49, 50, 36, 48, 59,
    59, 38, 34, 45, 38, 31, 58, 39, 39, 39, 34, 38, 54, 39, 41, 39, 39, 39, 25, 50, 37,
];
pub const SIG_COEFF_FLAG_SHIFT: &[u8] = &[
    12, 9, 9, 10, 9, 9, 9, 10, 8, 8, 8, 10, 9, 13, 8, 8, 8, 8, 8, 5, 8, 0, 0, 0, 8, 8, 8, 8, 8, 0,
    4, 4, 0, 0, 0, 0, 12, 12, 9, 13, 4, 5, 8, 9, 8, 12, 12, 8, 4, 0, 0, 0, 8, 8, 8, 8, 4, 0, 0, 0,
    13, 13, 8, 12, 9, 9, 10, 9, 9, 9, 10, 8, 8, 8, 10, 9, 13, 8, 8, 8, 8, 8, 5, 8, 0, 0, 0, 8, 8,
    8, 8, 8, 0, 4, 4, 0, 0, 0, 0, 12, 12, 9, 13, 4, 5, 8, 9, 8, 12, 12, 8, 4, 0, 0, 0, 8, 8, 8, 8,
    4, 0, 0, 0, 13, 13, 8, 12, 9, 9, 10, 9, 9, 9, 10, 8, 8, 8, 10, 9, 13, 8, 8, 8, 8, 8, 5, 8, 0,
    0, 0, 8, 8, 8, 8, 8, 0, 4, 4, 0, 0, 0, 0, 12, 12, 9, 13, 4, 5, 8, 9, 8, 12, 12, 8, 4, 0, 0, 0,
    8, 8, 8, 8, 4, 0, 0, 0, 13, 13, 8,
];

/// Table 124 — `par_level_flag` (99 ctxIdx, 33 per initType).
/// r415 full retranscription (see the Table 123 note).
pub const PAR_LEVEL_FLAG_INIT: &[u8] = &[
    33, 25, 18, 26, 34, 27, 25, 26, 19, 42, 35, 33, 19, 27, 35, 35, 34, 42, 20, 43, 20, 33, 25, 26,
    42, 19, 27, 26, 50, 35, 20, 43, 11, 18, 17, 33, 18, 26, 42, 25, 33, 26, 42, 27, 25, 34, 42, 42,
    35, 26, 27, 42, 20, 20, 25, 25, 26, 11, 19, 27, 33, 42, 35, 35, 43, 3, 33, 40, 25, 41, 26, 42,
    25, 33, 26, 34, 27, 25, 41, 42, 42, 35, 33, 27, 35, 42, 43, 33, 25, 26, 34, 19, 27, 33, 42, 43,
    35, 43, 11,
];
pub const PAR_LEVEL_FLAG_SHIFT: &[u8] = &[
    8, 9, 12, 13, 13, 13, 10, 13, 13, 13, 13, 13, 13, 13, 13, 13, 10, 13, 13, 13, 13, 8, 12, 12,
    12, 13, 13, 13, 13, 13, 13, 13, 6, 8, 9, 12, 13, 13, 13, 10, 13, 13, 13, 13, 13, 13, 13, 13,
    13, 10, 13, 13, 13, 13, 8, 12, 12, 12, 13, 13, 13, 13, 13, 13, 13, 6, 8, 9, 12, 13, 13, 13, 10,
    13, 13, 13, 13, 13, 13, 13, 13, 13, 10, 13, 13, 13, 13, 8, 12, 12, 12, 13, 13, 13, 13, 13, 13,
    13, 6,
];
...
/// Table 125 — `abs_level_gtx_flag` (216 ctxIdx, 72 per initType).
/// r415 full retranscription (see the Table 123 note).
pub const ABS_LEVEL_GTX_FLAG_INIT: &[u8] = &[
    ...
    17, 26, 19, 35, 21, 25, 34, 20, 28, 29, 33, 27, 28, 29, 22, 34, 28, 44, 37, 38, 0, 25, 19, 20,
    13, 14, 57, 44, 30, 30, 23, 17, 0, 1, 17, 25, 18, 0, 9, 25, 33, 34, 9, 25, 18, 26, 20, 25, 18,
    19, 27, 29, 17, 9, 25, 10, 18, 4, 17, 33, 19, 20, 29, 18, 11, 4, 28, 2, 10, 3, 3, 0, 0, 33, 34,
    35, 21, 25, 34, 35, 28, 29, 40, 42, 43, 29, 30, 49, 36, 37, 45, 38, 0, 40, 34, 43, 36, 37, 57,
    52, 45, 38, 46, 25, 0, 0, 17, 25, 26, 0, 9, 25, 33, 19, 0, 25, 33, 26, 20, 25, 33, 27, 35, 22,
    25, 1, 25, 33, 26, 12, 25, 33, 27, 28, 37, 19, 11, 4, 6, 3, 4, 4, 5,
];
pub const ABS_LEVEL_GTX_FLAG_SHIFT: &[u8] = &[
    9, 5, 10, 13, 13, 10, 9, 10, 13, 13, 13, 9, 10, 10, 10, 13, 8, 9, 10, 10, 13, 8, 8, 9, 12, 12,
    10, 5, 9, 9, 9, 13, 1, 5, 9, 9, 9, 6, 5, 9, 10, 10, 9, 9, 9, 9, 9, 9, 6, 8, 9, 9, 10, 1, 5, 8,
    8, 9, 6, 6, 9, 8, 8, 9, 4, 2, 1, 6, 1, 1, 1, 1, 9, 5, 10, 13, 13, 10, 9, 10, 13, 13, 13, 9, 10,
    10, 10, 13, 8, 9, 10, 10, 13, 8, 8, 9, 12, 12, 10, 5, 9, 9, 9, 13, 1, 5, 9, 9, 9, 6, 5, 9, 10,
    10, 9, 9, 9, 9, 9, 9, 6, 8, 9, 9, 10, 1, 5, 8, 8, 9, 6, 6, 9, 8, 8, 9, 4, 2, 1, 6, 1, 1, 1, 1,
    9, 5, 10, 13, 13, 10, 9, 10, 13, 13, 13, 9, 10, 10, 10, 13, 8, 9, 10, 10, 13, 8, 8, 9, 12, 12,
    10, 5, 9, 9, 9, 13, 1, 5, 9, 9, 9, 6, 5, 9, 10, 10, 9, 9, 9, 9, 9, 9, 6, 8, 9, 9, 10, 1, 5, 8,
    8, 9, 6, 6, 9, 8, 8, 9, 4, 2, 1, 6, 1, 1, 1, 1,
];
